...
namespace microb_uy_mobile.Pages.BasePages
{
    public partial class BaseNewReplyPage : ContentPage
    {
        ...
        public virtual void LoadMainPostDetails()
        {
        ...
        public virtual async void OnPublishButtonClicked(object sender, EventArgs e)
        {
        ...
        public virtual async void OnCancelButtonClicked(object sender, EventArgs e)
        {
            // Cerrar el teclado
            PostEditor.Unfocus();
