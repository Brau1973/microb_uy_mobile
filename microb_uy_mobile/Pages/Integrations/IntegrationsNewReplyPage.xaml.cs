    ...
    public partial class IntegrationsNewReplyPage : ContentPage
    {
        ...
        public async void OnPublishButtonClicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                await DisplayAlert("INTEGRATIONS", "Contenido de respuesta vacío", "OK");
            }
        }
